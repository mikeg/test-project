...
<title>BoN Online System - Search</title>
<!-- InstanceEndEditable -->
...
<table width="1050" border="0" cellspacing="0" cellpadding="0" align="center" id="tablebody">
 ...
 <tr>
	...
	<table border="0" cellspacing="0" cellpadding="0" width="900" align="center">
      <tr>
        <td width="900" class="pageName"><!-- InstanceBeginEditable name="contentName" -->STUDENT SEARCH<!-- InstanceEndEditable --> </td>
      </tr>
      <tr>
					...
					<table width="100%" align="right">
							...
							<tr>
								<td align="left" bgcolor="#6699FF">
									<form name="searchform" action="scsearch.php" enctype="multipart/form-data" method="post">
										<div class="divLastClass">Last Name<br /> <input type="text" name="lastName" align="left" />
										&nbsp;</div>
										<div class="divLastClass">First Name<br /><input type="text"  name="firstName" align="left" />
										&nbsp;</div>
										<div class="divLastClass">School Name<br /><input type="text" name="schoolName" align="left" />
										&nbsp; </div>
										<div class="divLastClass"><br /><input type="submit" name="search" value="GO" /><br />&nbsp; </div>
									</form>
								</td>
							</tr>
							<tr>
								<td width="100%" align="left" class="bodyText" >
									...
									<table width="100%" border="1px" bordercolor="#0000FF" cellpadding="1" cellspacing="0">
										<tr>
											<th width="20%" class="thead">Last Name</th>
											<th width="20%" class="thead">First Name</th>
											<th width="40%"  class="thead">School Name</th>
											<th width="15%" class="thead">Status</th>
											<th width="5%"  class="thead">Transfer</th>
										</tr>
										<? $i=0;
											for (; $i<5; $i++)
										{ ?>
										...
										<tr>
											<th width="20%" align="left" class="tcontent">Last Name</th>
											<th width="20%" align="left" class="tcontent">First Name</th>
											<th width="40%" align="left" class="tcontent">School Name</th>
											<th width="15%" align="center" class="tcontent">Status</th>
											<th width="5%"  align="left" class="tcontent"><input type="submit" name="submit" value="Transfer" /></th>
										</tr>
										</form>
										<? } ?>
									</table>
