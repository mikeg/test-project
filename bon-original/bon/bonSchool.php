											...
											<td width="85%" align="left">
												...
												<br/><table id='addRegTable' border="3" width="100%" bordercolor="#0099FF" cellspacing="5">																
														<tr>
															...
															<td>&nbsp;Firstname: <input type="text" size="25" id="addRegFrst0"></input><br/>&nbsp;Lastname: <input type="text" size="25" id="addRegLst0"></input></td>
															<td align="center">&nbsp;Username: <input type="text" size="25" id="addRegUser0"></input><br/>&nbsp;Password: <input type="password" size="25" id="addRegPass0"></input></td>						
															<td align="center">&nbsp;Access: <input type="checkbox" id="addRegChk0"></input></td>
														</tr>
														
														<tr>
															<td align="right" width="15%">Registrar 2:</td> 
															<td>&nbsp;Firstname: <input type="text" size="25" id="addRegFrst1"></input><br/>&nbsp;Lastname: <input type="text" size="25" id="addRegLst1"></input></td>
															<td align="center">&nbsp;Username: <input type="text" size="25" id="addRegUser1"></input><br/>&nbsp;Password: <input type="password" size="25" id="addRegPass1"></input></td>						
							...
							<tr>
								<td width="100%" align="left">
									<table width="100%" cellspacing="0" align="center">
										...
										<form name="searchSchool" method="post" enctype="multipart/form-data" action="bonschool.php">
										<tr>
				...
				<td width="100%" align="right">
					<table width="100%" align="right">
							<tr>
								<td width="100%" align="left">
									<table width="100%" cellspacing="0" align="center">
										<form name="search2School" method="post" enctype="multipart/form-data" action="bonschool.php">
				...
				<td width="100%" align="right">
					<table width="100%" align="right">
							<tr>
								<td width="100%" align="left">
									<table width="100%" cellspacing="0" align="center">
										<form name="search3School" method="post" enctype="multipart/form-data" action="bonschool.php">
										<tr>
