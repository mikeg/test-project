 ...
 <tr>
	...
	<table cellspacing="15" cellpadding="0" width="900" align="center">
      ...
      <tr>
								...
								<td width="100%" align="left" class="bodyText" >
									<table width="100%" bordercolor="#0000FF" cellpadding="1" cellspacing="0" align="center">
										...
										<tr>
											...
											<td width="85%" align="left"><br/> <input type="text" size="50" name="fosterName">
											<br/><br/></td>
										</tr>
		...
		<table width="100%">
		<td align="right" width="410"><div align="right">
		  <input type="reset" value="CANCEL">
		  </div></td><br/>
		<td align="left" width="438"><div align="left">
		...
		<? if ($edit=="Edit Search" || $edit2=="EDIT" || $search2 =="SEARCH"){ ?>
			<form name="searchFoster"enctype="multipart/form-data" method="post">
				 <table align="center" width="100%" >
			<tr>
				<td width="100%" align="right">
					<table width="100%" align="right">
								...
								<td width="100%" align="left">
									<table width="100%" cellspacing="0" align="center">
										  ...
										  <option>Isabela</option>
												...
												&nbsp;Firstname/Lastname:
												<input type="text" name="cashierName" size="30" />												
												&nbsp;
