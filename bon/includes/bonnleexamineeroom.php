			...
			<tr>
				<td width="100%" align="right">
					...
					<br/><th class="thead" ><div align="center">LIST OF EXAMINEES - Room Assignment</div></th>
							...
							<tr>
								...
								<table width="100%" border="1px" bordercolor="#0000FF" cellpadding="1" cellspacing="0" >
									<tr>
										...
										<th width="10%" align="center" >Examinee No.</th>
										<th width="20%" align="center" >Student Name</th>
										<th width="15%" align="center" >Testing Center</th>
										<th width="20%" align="center" >School Name</th>
										<th width="10%" align="center" >Room Name</th>
							...
							<tr>
								<form name="form"  method="GET" enctype="multipart/form-data" action="includes/bonpdf/createPDF.php" target="_blank" >
								<td align="center">
										<br/>
