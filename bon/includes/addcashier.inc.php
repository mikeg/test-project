							...
							<tr>
								...
								<!--		<tr>
										...
										<tr>
											...
											?> 
													checked <?php }?> > 
												<label for="enable">	<font color="#006600"><strong>enable</strong></font> </label>
											 <input type="radio" name="enableAcc" value="0" id="disable"
											  <?php if($_GET['enableAcc'] == "0"){
											  ?> 		
											  			checked 
												<?php }?> > 
												<label for="disable">	<font color="#FF0000"><strong/>disable</font></label>
											</input>
											</td>
										</tr>
				...
				$insertcashier = 'INSERT INTO users (
					...
					if($fn!="" && $ln!="" && $loc!="" && $pos!="" && $un!="" && $pass!="" && $stat!=""){
							...
							if(!@mysql_query($insertcashier)){
								echo '<script language="javascript">alert("Cashier NOT Added. Duplicate ENTRY on Username")</script>';
												echo(mysql_error()); 			
							...
							echo '<script language="javascript">alert("Cashier successfully added.")</script>';

								//echo 'Cashier added.<br>';
								
							}
					} else{
							echo '<script language="javascript">alert("Cashier NOT Added. Check your entries")</script>';
...
?>
		...
		<table width="100%">
			<td width="50%" align="right"><input type="reset" value="CANCEL" name="resetx"/></td>
