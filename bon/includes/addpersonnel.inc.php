...
<form name="personnel" method="GET" enctype="multipart/form-data" >
								...
								<td width="100%" align="left" class="bodyText" >
									...
									<table width="100%" bordercolor="#0000FF" cellpadding="1" cellspacing="0" align="center">
										<tr>
											...
											<input name="add" type="hidden" id="add" value="Add Personnel" />
										...
										<td width="85%" align="left"><br/> <input type="text" size="30" name="firstName" value="<?php echo $_GET['firstName'];?>" ><br/><br/></td>
										</tr>
										
										<tr>
										<td width="15%" align="right"> Lastname:<br/><br/></td> 
										<td width="85%" align="left"> <input type="text" size="30" name="lastName" value="<?php echo $_GET['lastName'];?>" ><br/><br/></td>
										</tr>
										
								<tr>
									<td width="15%" align="right"> Location Handled:</td> 
									<? //this table data handles the query of the prclocations ?>
                                  ...
                                  <?php } ?>
										...
										<td width="85%" align="left"> <br/><input type="text" size="25" name="employeeNo" value="<?php echo $_GET['employeeNo'];?>" /><br/><br/></td>
										</tr>
										
								<!--		<tr>
										<td width="15%" align="right">Position:<br/><br/></td> 
										<td width="85%" align="left"><input type="text" size="30" name="position" value="<?php echo $_GET['position'];?>" /><br/><br/></td>
										</tr>
 								-->										
										...
										<td width="85%" align="left"><input type="text" size="25" name="username"/ value="<?php echo $_GET['username'];?>" ><br/><br/></td>
										</tr>
										
											
										<tr>
										<td width="15%" align="right">Password:<br/><br/></td> 
										<td width="85%" align="left"><input type="password" size="25" name="password" value="<?php echo $_GET['password'];?>"  /><br/><br/></td>
										</tr>
										
										<tr>
										<td width="15%" align="right">Access:</td> 
										<td width="85%" align="left"> 
											<input name="enableAcc" type="radio" value="1" id="enable" 
											<?php if($_GET['enableAcc'] == "1"){
											?> 
													checked <?php }?> > 
													<font color="#006600"><strong><label for="enable">enable</label></strong></font>
											</input>
											 <input type="radio" name="enableAcc" value="0" id="disable"
											  <?php if($_GET['enableAcc'] == "0"){
											  ?> 		
											  			checked 
												<?php }?> > 
													<font color="#FF0000"><strong/><label for="disable">disable</label></font>
											</input>
											</td>
										</tr>
...
// these codes handles the insertion of the values supplied above			
			...
			if(isset($_GET['submitx'])){
				...
				$insertpersonnel = 'INSERT INTO users (
												user_first,
												user_last,
												location,
												position,
					...
					if($fn!="" && $ln!="" && $loc!="" && $pos!="" && $un!="" && $pass!="" && $stat!=""){
							...
							if(!@mysql_query($insertpersonnel)){
								echo '<script language="javascript">alert("NOA Personnel NOT Added. Duplicate ENTRY on Username")</script>';
								echo(mysql_error()); 
								
								//echo 'NOA Personnel not added. Check your entries<br>';					
							}
							else{
						...
						echo '<script language="javascript">alert("NOA Personnel successfully added.")</script>';

							
							}
					} else {
						echo '<script language="javascript">alert("NOA Personnel NOT added. Check your entries.")</script>';
						}
