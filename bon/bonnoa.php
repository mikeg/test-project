...
<table width="1050" border="0" cellspacing="0" cellpadding="0" align="center" id="tablebody">
 ...
 <tr>
	...
	<table cellspacing="15" cellpadding="0" width="900" align="center">
      <tr>
        <td width="900" class="pageName"><!-- InstanceBeginEditable name="contentName" -->NOA PERSONNEL<!-- InstanceEndEditable --> </td>
      </tr>
      <tr>
        <td class="bodyText"><!-- InstanceBeginEditable name="content" -->
		 ...
		 <tr>
		   <td>
				<form action="" method="GET" enctype="multipart/form-data" name="noa" id="noa" >	
					<input type="submit" name="edit" value="Edit / Search"/> 
					&nbsp;<input type="submit" value="Add Personnel" name="add" />
						
				</form>
				 
		<? if ($add=="Add Personnel"){ ?>
			<? include("includes/addpersonnel.inc.php") ?>	
		<? } ?>
		
		<? if ($edit=="Edit / Search"){ ?>
			<? include("includes/editpersonnel.inc.php") ?>
		<? } ?>
