function addReg(){
		...
		var newReg = "<tr>";
			newReg += "<td width='12%' align='right'>Registrar:<br/><br/></td>";
			newReg += "<td>Firstname: <input type='text' size='30' id=" + rowFrstId + "> </input><br/>Lastname: <input type='text' size='30' id=" + rowLstId + "></input></td>";
			newReg += "<td align = 'left'>Username: <input type='text' size='30' id=" + rowUserId + "> </input><br/>Password: <input type='password' size='30' id=" + rowPassId + "></input></td>";
