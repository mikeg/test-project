 ...
 <tr>
	...
	<table cellspacing="15" cellpadding="0" width="900" align="center">
	 ...
	 <table>
		...
		<td>
				<form action="bonlocation.php" method="get" enctype="multipart/form-data" name="location" id="location" >	
				&nbsp;<input type="submit" value="PRC Location Entry" name="addLocation" />
				</form>			
		</td>
	</tr>
	 </table>
		...
		<? if ($add=="Add Cashier"){ ?>
			<? include("includes/addcashier.inc.php") ?>	
		<? } ?>
		
		<? if ($edit=="Edit / Search"){ ?>
			<? include("includes/editcashier.inc.php") ?>
		<? } ?>
