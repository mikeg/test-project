...
<table width="1050" border="0" cellspacing="0" cellpadding="0" align="center" id="tablebody">
 ...
 <tr>
	...
	<table cellspacing="15" cellpadding="0" width="900" align="center">
      <tr>
        <td width="900" class="pageName"><!-- InstanceBeginEditable name="contentName" -->TRANSFERS<!-- InstanceEndEditable --> </td>
      </tr>
      <tr>
		...
		<table width="100%">
		  ...
		  <td>
				<form method="GET" enctype="multipart/form-data" >	
					<input type="submit" name="release" value="Search Within"/>
					&nbsp;<input type="submit" value="Search Outside" name="accept" >			
				</form>
		
			
		<? if ($accept=="Search Outside"){ ?>
			<? include("include/sraccepttransfer.php") ?>
		<? } ?>
		
		<? if ($release=="Search Within"){ ?>
			<? include("include/srreleasetransfer.php") ?>
		<? } ?>
		</td>
